...
public class H05_Tester {
    ...
    public static final Supplier<MethodTester> HYBRID_TYPE_1_TOGGLE_STANDARD_VOLTAGE_CHARGEABLE_MT = () -> new MethodTester(HYBRID_TYPE_1_CT.get(),
        ...
        Modifier.PUBLIC,
        void.class);
    public static final Supplier<MethodTester> HYBRID_TYPE_1_TOGGLE_HIGH_VOLTAGE_CHARGEABLE_MT = () -> new MethodTester(HYBRID_TYPE_1_CT.get(),
        "toggleHighVoltageChargeable",
        minSim,
        Modifier.PUBLIC,
        void.class);
    ...
    public static final Supplier<AttributeMatcher> HYBRID_TYPE_3_FUEL_TYPE_AM = () -> new AttributeMatcher(
        ...
        Modifier.PRIVATE | Modifier.STATIC,
        FUEL_TYPE_CT.get().findClass());
    public static final Supplier<AttributeMatcher> HYBRID_TYPE_3_AVERAGE_CONSUMPTION_AM = () -> new AttributeMatcher(
        "averageConsumption",
        minSim,
        Modifier.PRIVATE | Modifier.STATIC,
        double.class);
    public static final Supplier<AttributeMatcher> HYBRID_TYPE_3_STANDARD_VOLTAGE_CHARGEABLE_AM = () -> new AttributeMatcher(
        "standardVoltageChargeable",
        minSim,
        Modifier.PRIVATE | Modifier.STATIC,
        boolean.class);
    public static final Supplier<AttributeMatcher> HYBRID_TYPE_3_HIGH_VOLTAGE_CHARGEABLE_AM = () -> new AttributeMatcher(
        ...
        Modifier.PRIVATE | Modifier.STATIC,
        boolean.class);
    public static final Supplier<AttributeMatcher> HYBRID_TYPE_3_PREFERRED_DRIVE_TYPE_AM = () -> new AttributeMatcher(
        "preferredDriveType",
        minSim,
        Modifier.PRIVATE | Modifier.STATIC,
        DRIVE_TYPE_CT.get().findClass());
    ...
    public static final Supplier<MethodTester> HYBRID_TYPE_3_TOGGLE_STANDARD_VOLTAGE_CHARGEABLE_MT = () -> new MethodTester(HYBRID_TYPE_3_CT.get(),
        ...
        Modifier.PUBLIC,
        void.class);
    public static final Supplier<MethodTester> HYBRID_TYPE_3_TOGGLE_HIGH_VOLTAGE_CHARGEABLE_MT = () -> new MethodTester(HYBRID_TYPE_3_CT.get(),
        "toggleHighVoltageChargeable",
        minSim,
        Modifier.PUBLIC,
        void.class);

    public static final Supplier<MethodTester> HYBRID_TYPE_3_TOGGLE_PREFERRED_DRIVE_TYPE_MT = () -> new MethodTester(HYBRID_TYPE_3_CT.get(),
        "togglePreferredDriveType",
        minSim,
        Modifier.PUBLIC,
        void.class);
}
