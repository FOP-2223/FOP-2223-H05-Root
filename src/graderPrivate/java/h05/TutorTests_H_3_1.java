...
public class TutorTests_H_3_1 {
    ...
    private void test_fill_up(int fillValue) throws InvocationTargetException, IllegalAccessException {
        Field filling_level_field = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolve().resolveAttribute(H05_Tester.FUEL_DRIVEN_VEHICLE_FILLING_LEVEL_AM);
        Object instance = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolve().getNewRealInstance();
    ...
    public void test_filling() throws InvocationTargetException, IllegalAccessException {
        //Attribut und Getter
        Field filling_level_field = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolve().resolveAttribute(H05_Tester.FUEL_DRIVEN_VEHICLE_FILLING_LEVEL_AM);
        H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolve().assertHasGetter(filling_level_field);
    ...
    private void test_constructor(int fuelType, int transportType, int fillingLevel) throws Throwable {
        Constructor constructor = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolveConstructor(new ArrayList<>(Arrays.asList(H05_Tester.FUEL_DRIVEN_VEHICLE_CONSTRUCTOR_PARAMETER_MATCHERS)));

        Class fuelTypeClass = H05_Tester.FUEL_TYPE_CT.getTheClass();
        ...
        Field fuelType_field = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolveAttribute(H05_Tester.FUEL_DRIVEN_VEHICLE_FUEL_TYPE_AM);
        fuelType_field.setAccessible(true);
        Object actual_fuelType = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.getFieldValue(instance, fuelType_field);

        Field transportType_field = H05_Tester.MEANS_OF_TRANSPORT_CT.resolveAttribute(H05_Tester.MEANS_OF_TRANSPORT_TRANSPORT_TYPE_AM);
        transportType_field.setAccessible(true);
        Object actual_transportType = H05_Tester.MEANS_OF_TRANSPORT_CT.getFieldValue(instance, transportType_field);

        Field fillingLevel_field = H05_Tester.FUEL_DRIVEN_VEHICLE_CT.resolveAttribute(H05_Tester.FUEL_DRIVEN_VEHICLE_FILLING_LEVEL_AM);
        fillingLevel_field.setAccessible(true);
        int actual_filling_level = (int) H05_Tester.FUEL_DRIVEN_VEHICLE_CT.getFieldValue(instance, fillingLevel_field);
